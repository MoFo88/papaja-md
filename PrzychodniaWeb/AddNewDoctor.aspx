<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="AddNewDoctor.aspx.cs" Inherits="AddNewDoctor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="accountInfo">
        <asp:ValidationSummary ID="addSpecValidationSummary" runat="server" CssClass="failureNotification"
            ValidationGroup="addSpecValidationGroup" />
        <asp:ValidationSummary ID="addDataValidationSummary" runat="server" CssClass="failureNotification"
            ValidationGroup="addDataValidationGroup" />
        <fieldset>
            ...
            <p>
                ...
                <asp:RequiredFieldValidator ID="tbImieRequiredFieldValidator" runat="server" ControlToValidate="tbImie"
                    CssClass="failureNotification" ErrorMessage="Imię jest wymagane." ToolTip="Imię jest wymagane."
            ...
            <p>
                ...
                <asp:RequiredFieldValidator ID="tbNazwiskoRequiredFieldValidator" runat="server"
                    ControlToValidate="tbNazwisko" CssClass="failureNotification" ErrorMessage="Nazwisko jest wymagane."
                    ToolTip="Nazwisko jest wymagane." ValidationGroup="addDataValidationGroup">*</asp:RequiredFieldValidator>
            </p>
            <p>
            ...
            <p>
                ...
                <asp:RegularExpressionValidator ID="tbKodPocztowyRegularExpressionValidator" runat="server"
                    CssClass="failureNotification" ErrorMessage="Błędny kod pocztowy." ValidationGroup="addDataValidationGroup"
                    ControlToValidate="tbKodPocztowy" ToolTip="Błędny kod pocztowy." ValidationExpression="\d{2}-\d{3}">*</asp:RegularExpressionValidator>
            </p>
            <p>
            ...
            <p>
                ...
                <asp:RegularExpressionValidator ID="tbEmailRegularExpressionValidator" runat="server"
                    ControlToValidate="tbEmail" CssClass="failureNotification" ErrorMessage="Błędny adres e-mail."
                    ToolTip="Błędny adres e-mail." ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
            ...
            <p>
                ...
                <asp:RequiredFieldValidator ID="tbLoginRequiredFieldValidator" runat="server" ErrorMessage="Login jest wymagany."
                    ControlToValidate="tbLogin" CssClass="failureNotification" ToolTip="Login jest wymagany."
                    ValidationGroup="addDataValidationGroup">*</asp:RequiredFieldValidator>
            </p>
            <p>
                <asp:Label ID="Label11" runat="server" Text="Hasło:"></asp:Label>
                <asp:TextBox ID="tbPassword" runat="server" CssClass="textEntry" 
                    TextMode="Password"></asp:TextBox>
                <asp:RequiredFieldValidator ID="tbPasswordRequiredFieldValidator" runat="server"
                    ErrorMessage="Hasło jest wymagane." ControlToValidate="tbPassword" CssClass="failureNotification"
                    ToolTip="Hasło jest wymagane." ValidationGroup="addDataValidationGroup">*</asp:RequiredFieldValidator>
            </p>
            ...
            <p class="submitButton">
                <asp:Button ID="BtnSubmit" runat="server" Text="Zatwierdź" OnClick="BtnSubmit_Click"
                    ValidationGroup="addDataValidationGroup" />
            </p>
            <p>
