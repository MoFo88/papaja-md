<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="MyAccountAdmin.aspx.cs" Inherits="MyAccountAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="myData">
        ...
        <h1>
            <asp:Label ID="lblAdmin" runat="server" Text="Administrator"></asp:Label></h1>
        <br />
        <p>
            <asp:Label ID="lblName_" runat="server" Text="Imię: "></asp:Label><asp:Label ID="lblName"
                runat="server"></asp:Label></p>
        <p>
            <asp:Label ID="lblSurname_" runat="server" Text="Nazwisko: "></asp:Label><asp:Label
                ID="lblSurname" runat="server"></asp:Label></p>
        <p>
            <asp:Label ID="lblPhone_" runat="server" Text="Telefon: "></asp:Label><asp:Label
                ID="lblPhone" runat="server"></asp:Label></p>
        <p>
            <asp:Label ID="lblEmail_" runat="server" Text="Email: "></asp:Label><asp:Label ID="lblEmail"
                runat="server"></asp:Label></p>
        <asp:Panel ID="panelShowEdidPassword" runat="server" CssClass="showPanel">
            <div class="imageArrowContainer">
                <asp:Image ToolTip="Zmień hasło" runat="server" CssClass="imageArrow" ID="arrow2"
                    ImageUrl="~/images/arrowDown2.jpg" /><asp:Label runat="server" ID="Label1" Text="Zmień hasło"></asp:Label></div>
        </asp:Panel>
        <asp:CollapsiblePanelExtender ID="CollapsiblePanelExtender1" runat="server" ImageControlID="arrow2"
            CollapsedImage="~/images/arrowDown2.jpg" ExpandedImage="~/images/arrowUp2.jpg"
            TargetControlID="panelEditPassword" Collapsed="true" CollapseControlID="panelShowEdidPassword"
            ExpandControlID="panelShowEdidPassword">
        ...
        <asp:Panel ID="panelEditPassword" runat="server" CssClass="collapsePanel">
            <div class="accountInfo">
                ...
                <fieldset>
                    ...
                    <p>
                        ...
                        <asp:RequiredFieldValidator ID="confirmPasswordRequiredFieldValidator" runat="server"
                            ControlToValidate="tbConfPassword" CssClass="failureNotification" ErrorMessage="Potwierdzenie Hasła jest wymagane."
                            ToolTip="Potwierdzeie hasła jest wymagane." ValidationGroup="editPasswordValidationGroup">*</asp:RequiredFieldValidator>
                        <asp:CompareValidator ID="passwordCompareValidator" runat="server" ErrorMessage="Hasła nie są identyczne."
                            ValidationGroup="editPasswordValidationGroup" ControlToValidate="tbPassword"
                            ControlToCompare="tbConfPassword" CssClass="failureNotification" ToolTip="Hasła nie są identyczne">*</asp:CompareValidator>
                    </p>
                    <p>
                ...
                <p class="submitButton">
                    <asp:Button ID="btnChangePassword" runat="server" Text="Edytuj" OnClick="btnChangePassword_Click"
                        ValidationGroup="editPasswordValidationGroup" />
                </p>
            </div>
        </asp:Panel>
    ...
    <asp:Panel ID="panelShowEdit" runat="server" CssClass="showPanel">
        <div class="imageArrowContainer">
            <asp:Image ToolTip="Edytuj Dane" runat="server" CssClass="imageArrow" ID="arrow"
                ImageUrl="~/images/arrowDown2.jpg" /><asp:Label runat="server" ID="lblEdit" Text="Edytuj dane"></asp:Label></div>
    </asp:Panel>
    <asp:CollapsiblePanelExtender ID="CollapsiblePanelExtenderpanelEdit" runat="server"
        ImageControlID="arrow" CollapsedImage="~/images/arrowDown2.jpg" ExpandedImage="~/images/arrowUp2.jpg"
        TargetControlID="panelEdit" Collapsed="true" CollapseControlID="panelShowEdit"
        ExpandControlID="panelShowEdit" SuppressPostBack="true">
    </asp:CollapsiblePanelExtender>
        ...
        <div class="accountInfo">
            ...
            <fieldset>
                ...
                <p>
                    ...
                    <asp:RequiredFieldValidator ID="tbEditNameRequiredFieldValidator" runat="server"
                        ControlToValidate="tbEditName" CssClass="failureNotification" ErrorMessage="Imię jest wymagane."
                        ToolTip="Imię jest wymagane." ValidationGroup="editDataValidationGroup">*</asp:RequiredFieldValidator>
                </p>
                <p>
                    ...
                    <asp:RequiredFieldValidator ID="tbEditSurnameRequiredFieldValidator" runat="server"
                        ControlToValidate="tbEditSurname" CssClass="failureNotification" ErrorMessage="Nazwisko jest wymagane."
                        ToolTip="Nazwisko jest wymagane." ValidationGroup="editDataValidationGroup">*</asp:RequiredFieldValidator>
                </p>
                <p>
                ...
                <p>
                    ...
                    <asp:RegularExpressionValidator ID="tbEditEmailRegularExpressionValidator" runat="server"
                        ControlToValidate="tbEditEmail" ValidationGroup="editDataValidationGroup" ToolTip="Błędny adres email"
                        CssClass="failureNotification" ErrorMessage="Błędny adres email." ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">*</asp:RegularExpressionValidator>
                </p>
                <p>
                ...
                <p>
                    ...
                    <asp:RegularExpressionValidator ID="tbEditPostalCodeRegularExpressionValidator" runat="server"
                        ToolTip="Błedny kod pocztowy" ControlToValidate="tbEditPostalCode" CssClass="failureNotification"
                        ValidationGroup="editDataValidationGroup" ErrorMessage="Błedny kod pocztowy."
                ...
                <p>
                    ...
                    <asp:RequiredFieldValidator ID="tbEditLoginRequiredFieldValidator" runat="server"
                        ControlToValidate="tbEditLogin" CssClass="failureNotification" ErrorMessage="Login jest wymagany."
                        ToolTip="Login jest wymagany." ValidationGroup="editDataValidationGroup">*</asp:RequiredFieldValidator>
                </p>
                <p>
            ...
            <p class="submitButton">
                <asp:Button ID="btnSubmitEdit" runat="server" Text="Edytuj" OnClick="btnSubmitEdit_Click"
                    ValidationGroup="editDataValidationGroup" />
            </p>
        </div>
    </asp:Panel>
    <div id="adminOptions" class="adminOptions">
        ...
        <asp:DynamicHyperLink ID="dhlEditSpecializations" runat="server" NavigateUrl="~/SpecializationsData.aspx">
            <div class="imageArrowContainer">
                <asp:Image ID="Image6" runat="server" ImageUrl="~/images/arrowRight.jpg" CssClass="imageArrow" />
                <asp:Label ID="Label2" runat="server" Text="Edytuj specjalizacje"></asp:Label>
            </div>
        </asp:DynamicHyperLink>
    </div>
</asp:Content>
