<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="DrReservations.aspx.cs" Inherits="DrReservations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:Panel ID="drChoosePanel" runat="server">
        <div class="accountInfo">
            <fieldset>
                ...
                <asp:DropDownList ID="ddlDrList" runat="server" AutoPostBack="True" 
                        onselectedindexchanged="ddlDrList_SelectedIndexChanged">
                </asp:DropDownList></p>
                <p>
    ...
    <asp:Panel ID="panelDateChoose" runat="server" Visible="False" CssClass="hoursReservation">
        <h3>
            Wybór tygodnia:</h3>
        <p>
